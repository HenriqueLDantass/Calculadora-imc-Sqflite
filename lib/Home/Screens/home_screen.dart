...
import 'package:calculadoraimcbancooff/data/local_data.dart';
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              if (key.currentState!.validate()) {
                ...
                await LocalData().insertImcEntry(result);
          ...
          FutureBuilder<List<ImcModel>>(
            future: LocalData().getImcEntries(),
                ...
                return Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ImcModel result = snapshot.data![index];
                      return Card(
                        elevation: 2,
                        child: ListTile(
